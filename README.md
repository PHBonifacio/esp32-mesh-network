...
# Rede de Sensores Mesh

### Projeto desenvolvido para a matéria Internet das Coisas - IoT da Especialização em Sistemas Embarcados - Senai Anchieta

* Necessário configurar o nome da rede wifi no **menuconfig**
